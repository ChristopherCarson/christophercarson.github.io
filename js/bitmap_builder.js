...
class BITMAP_BUILDER{
    constructor(_container, state){
        ...
        this.GRID_DIV.title = "Controls: \u000d 1. Draw with black by left-clicking \u000d 2. Draw with white by right-clicking \u000d 3. Zoom in/out using left ctrl + scrollwheel";
        // this.GRID_DIV.setAttribute("uk-tooltip", "delay: 500; pos: bottom-left; offset: 0; title: Controls:<br> 1. Draw with black by left-clicking <br> 2. Draw with white by right-clicking <br> 3. Zoom in/out using left ctrl + scrollwheel");
